...
from GestionProducto import ModGestionProductoItem
from GestionPrestamo import ModGestionPrestamoItem
from GestionUsuario import ModGestionUsuarioItem
...
class Depot(QMainWindow):
    ...
    def setLists(self):
        ...
        ModGestionProductoItem(self.buttonBack, self.listNotifications, iconMenu, 'Gestion de Inventario', self.listMenu)
        ModGestionPrestamoItem(self.buttonBack, self.listNotifications, iconMenu, 'Gestion de Prestamos', self.listMenu)
        ModGestionUsuarioItem(self.buttonBack, self.listNotifications, iconMenu, 'Gestion de Usuarios', self.listMenu)
